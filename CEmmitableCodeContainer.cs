...
namespace MiniC
{
    ...
    public abstract class CEmmitableCodeContainer
    {
        ...
        protected VariableType m_variableType = VariableType.VT_NA;
        ...
        public VariableType MVariableType => m_variableType;
    ...
    public class CodeContainer : CEmmitableCodeContainer
    {
        ...
        public CodeContainer(CodeContainerType mContainerType, CEmmitableCodeContainer mParent) : base(mContainerType, mParent)
        {
